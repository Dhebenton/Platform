...
import {
  AnalyticsIcon, MobinaIcon, OverviewIcon, PerfromanceIcon,
  SplitTestingIcon, VisibilityIcons, ContentAndAssets,
  ModulesHub, LogIcon, SecurityIcon, InfrastructureIcon
} from '../../../assets/Icons'
...
const TAB_GROUPS = [
  {
    ...
    tabs: [
      ...
      { label: 'Analytics',  icon: <AnalyticsIcon />,   path: 'analytics',  ready: true  },
...
export default function Tabs() {
  ...
  // Build base path from URL params — falls back gracefully if not yet on scoped route
  const base = orgId && siteId ? `/${orgId}/${siteId}` : ''
